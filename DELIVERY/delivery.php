...
<header>
        ...
        <nav class="nav-bar">
            <ul>
                ...
                <li><a href="profile.php">Profile</a></li> <!-- Added profile link -->
...
$sql = "SELECT fd.Fid AS Fid,fd.location as cure, fd.name,fd.phoneno,fd.date,fd.delivery_address, fd.address as From_address, 
...
<a href="deliverymyord-2.php">My orders</a>
...
?>
            ...
            <td data-label="Action" style="margin:auto">
                ...
                <?php } else if ($row['delivery_address'] == $id) { ?>
