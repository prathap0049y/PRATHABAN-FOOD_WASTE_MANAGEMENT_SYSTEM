...
if (isset($_POST['sign'])) {
    ...
    if ($num == 1) {
        ...
        $query = "insert into login(name,email,password,gender,phone) values('$username','$email','$pass','$gender','$phone')"; // Added phone number
        ...
        <div class="container">
            <div class="regform">
                ...
                <form action=" " method="post">
                    ...
                    <div class="input">
                        <label class="textlabel" for="phone">Phone no</label> <!-- Added phone number field -->
                        <input type="text" id="phone" name="phone" required /> <!-- Added phone number field -->
                    </div>
