...
<body>
  ...
  <section class="banner">
    <div class="hello">
      ...
      <a href="request_form.php">Request food</a>
    </div>
  </section>
  <div class="content">
    <h2>Love Food</h2>
  ...
  <div class="wrapperphoto">
    <div class="cols">
      ...
      <div class="col" ontouchstart="this.classList.toggle('hover');">
        <div class="container">
          <div class="front" style="background-image: url(img/flip2.jpeg)">
            <div class="inner">
              <p>Donate Food</p>
          ...
          <div class="back">
            <div class="inner">
              <p>Every meal you donate brings hope to someone in need. Join us in reducing hunger and food waste.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col" ontouchstart="this.classList.toggle('hover');">
        <div class="container">
          <div class="front" style="background-image: url(img/flip1.jpg)">
            <div class="inner">
              <p>Volunteer With Us</p>
              <span>Be a Food Hero</span>
            </div>
          </div>
          <div class="back">
            <div class="inner">
              <p>Help us collect and distribute food to those in need. Your time and effort can save lives.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col" ontouchstart="this.classList.toggle('hover');">
        <div class="container">
          <div class="front" style="background-image: url(img/flip3.jpg)">
            <div class="inner">
              <p>Request Food</p>
              <span>Get Help</span>
            </div>
          ...
          <div class="back">
            <div class="inner">
              <p>Don't go to bed hungry. Request a meal and we'll make sure you have something to eat.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col" ontouchstart="this.classList.toggle('hover');">
        <div class="container">
          <div class="front" style="background-image: url(img/flip4.jpg)">
            <div class="inner">
              <p>Support Us</p>
          ...
          <div class="back">
            <div class="inner">
              <p>Your support helps us continue our mission to reduce food waste and feed the hungry.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <ul id="donation-list">
      ...
      if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
          echo "<li>" . $row["name"] . " donated " . $row["quantity"] . " on " . $row["date"] . "</li>";
        }
      } else {
        echo "<li>No recent donations found.</li>";
      }
